...
class AFA_Events_Post_Types
{
	...
	public static function register_afa_events_post_types()
	{
		...
		// ---------------------------------------------------------------------------------------
		// COMPANIES
		$exhibitor_labels = array(
			'name'                     => _x('Exhibitor Directories', 'afa-events'),
			'singular_name'            => _x('Exhibitor Directory', 'afa-events'),
			'name_admin_bar'           => _x('Exhibitor Directories', 'afa-events'),
			'add_new'                  => _x('Add New Exhibitor Directory', 'afa-events'),
			'add_new_item'             => _x('Add New Exhibitor Directory', 'afa-events'),
			'edit_item'                => _x('Edit Exhibitor Directory', 'afa-events'),
			'new_item'                 => _x('New Exhibitor Directory', 'afa-events'),
			'view_item'                => _x('View Exhibitor Directory', 'afa-events'),
			'view_items'               => _x('View Exhibitor Directory', 'afa-events'),
			'search_items'             => _x('Search Exhibitor Directories', 'afa-events'),
			'not_found'                => _x('No Exhibitor Directories Found', 'afa-events'),
			'not_found_in_trash'       => _x('No Exhibitor Directories found in Trash', 'afa-events'),
			'parent_item_colon'        => _x('Parent Exhibitor Directory:', 'afa-events'),
			'all_items'                => _x('Exhibitor Directories', 'afa-events'),
			'archives'                 => _x('Exhibitor Directories Archives', 'afa-events'),
			'attributes'               => _x('Exhibitor Directories Attributes', 'afa-events'),
			'insert_into_item'         => _x('Insert into Exhibitor Directory', 'afa-events'),
			'uploaded_to_this_item'    => _x('Uploaded to this Exhibitor Directory', 'afa-events'),
			'featured_image'           => _x('Banner Image', 'afa-events'),
			'set_featured_image'       => _x('Set Banner Image', 'afa-events'),
			'remove_featured_image'    => _x('Remove Banner Image', 'afa-events'),
			'use_featured_image'       => _x('Usa as Banner Image', 'afa-events'),
			'menu_name'                => _x('Exhibitor Directories', 'afa-events'),
			'filter_items_list'        => _x('Filter Exhibitor Directories List', 'afa-events'),
			'filter_by_date'           => _x('Filter Exhibitor Directories by Posting Date', 'afa-events'),
			'items_list_navigation'    => _x('Exhibitor Directories List Navigation', 'afa-events'),
			'items_list'               => _x('Exhibitor Directories List', 'afa-events'),
			'item_published'           => _x('Exhibitor Directory Published', 'afa-events'),
			'item_published_privately' => _x('Exhibitor Directory Published Privately', 'afa-events'),
			'item_reverted_to_draft'   => _x('Exhibitor Directory Reverted to Draft', 'afa-events'),
			'item_trashed'             => _x('Exhibitor Directory Trashed', 'afa-events'),
			'item_scheduled'           => _x('Exhibitor Directory Posting Scheduled', 'afa-events'),
			'item_updated'             => _x('Exhibitor Directory Updated', 'afa-events'),
			'item_link'                => _x('Exhibitor Directory Link', 'afa-events'),
			'item_link_description'    => _x('A Link to an Exhibitor Directory', 'afa-events'),
		);
		$exhibitor_rewrite = array(
			'slug'                  => 'exhibitors',
		);
		$exhibitor_args = array(
			'label'                 => __('Exhibitor Directory', 'afa-events'),
			'description'           => __("AFA event Exhibitor Directories", 'afa-events'),
			'labels'                => $exhibitor_labels,
			...
			'menu_icon'             => 'dashicons-calendar-alt',
			'has_archive'           => false,
			'rewrite'               => $exhibitor_rewrite,
			'capability_type'       => 'post',
			'show_in_rest'			=> false,
			'show_in_menu'          => 'edit.php?post_type=company',
		);
		register_post_type('exhibitor', $exhibitor_args);
	}
